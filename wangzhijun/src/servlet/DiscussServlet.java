...
public class DiscussServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -1696365614965536167L;
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        public String refresh(String count) {
            ...
            try{
                ...
                String sql= "SELECT discussid, time, account, content FROM mxlake_discuss WHERE flag = 0 and father = "+count;
                ...
                while(rs.next()){
                	 // 通过字段检索
                	discussid = rs.getString("discussid");
                	time = rs.getString("time");
    	           	content = rs.getString("content");
    	            account = rs.getString("account");
    	            userinfo = getUserInfo(account);
    	            tmp = tmp+"{\"discussid\":\""+discussid+"\",\"time\":\""+time+userinfo+"\",\"content\":\""+content+"\"},";
