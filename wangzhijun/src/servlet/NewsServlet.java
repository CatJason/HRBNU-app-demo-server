...
public class NewsServlet extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2348586668374562335L;
	// JDBC 驱动名及数据库 URL
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        public String refresh(String count) {
            ...
            try{
                ...
                String sql= "SELECT newid, time, newtitle, account, tag1, tag2, tag3 FROM mxlake_news ORDER BY time DESC limit "+count+",10;";
